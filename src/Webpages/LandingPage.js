...
function LandingPage() {
  ...
  return (
      <div  id='components_container'>
          <h1 id='title' style={{color: '#ffffff'}}>ANIME HAVEN</h1>
          {/* Search Bar */}
          <div id='search_bar_container'>
            <input id='search_bar' type='text' placeholder='Enter anime name...'/>
            <div id='search_button' onClick={searchClick}>
              <div>
